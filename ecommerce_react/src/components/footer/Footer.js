...
const Footer = () => {
  return (
    <div>
      <div class="flex items-center justify-center border-b-2  bg-Primary border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between">
      ...
      <div className="bg-Footer text-white p-20 ">
        <Row gutter={10}>
          <Col sm={24} md={9}>
            <div className="flex flex-col justify-center items-center mb-5">
              ...
              <div className="text-justify">
                About consectetur adipiscing elit, sed do eiusmod tempor
