...
export const BtnSmall = ({ label, type, onClick, icon }) => {
  const buttonClasses =
    type === "primary"
      ? "bg-BgBtn hover:bg-BgBtnHover text-white  py-2 rounded-lg mt-2 px-4"
      : "   border border-dashed border-BgBtn hover:bg-BgBtn hover:text-white duration-300 text-black  py-2 rounded-lg mt-2 px-4";
