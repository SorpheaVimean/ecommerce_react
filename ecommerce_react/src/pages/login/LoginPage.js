...
const LoginPage = () => {
  ...
  const onFinish =
    loginType === "customer" ? onFinishCustomer : onFinishEmployee;
  return (
    <div>
      ...
      >
        <div className="bg-pink-500 bg-opacity-15 shadow-lg backdrop-blur-lg backdrop-filter border-10 border-solid border-white  rounded-xl text-white  px-10 w-[360px] md:w-[500px]">
          ...
          <div className="my-10  flex flex-col items-center justify-center  text-md font-bold leading-9 tracking-tigh text-gray-300">
            <button className="flex justify-between items-center gap-10 border-2 px-5 py-1 rounded-full border-slate-400 hover:border-white mb-2">
              <FcGoogle className=" text-2xl  " />
              <p className="  text-white ">Continue with Google</p>
            </button>
            <button className="flex justify-between items-center gap-6 border-2 px-5 py-1 rounded-full border-slate-400 hover:border-white mb-2">
